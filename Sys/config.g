...
M574 X1 S1 P"io6.in"		  			; active-high endstop for low end on X via pin io2.in                             
M574 Y1 S1 P"io3.in"		  			; active-high endstop for low end on Y via pin io1.in
M574 U2 S1 P"io5.in"					; active-high endstop for high end on U (X2) via pin io3.in                            
...
M308 S1 P"temp1" Y"thermistor" A"Extruder" T100000 B4450 C7.06e-8       ; configure sensor 1 as thermistor on pin temp0 
