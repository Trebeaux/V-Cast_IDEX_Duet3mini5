...
;Axis are in order of XYZU. So X=0, Y=1, Z=2, U=3. Delete the last "|| move.axes[3].homed" if you do not have a U Axis.  

;Check to see if the axis are homed, if no, home the axis 
